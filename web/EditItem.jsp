		...
		<div id="Login">
            ...
            <div id="center">
               ...
               else if(mrequest != null)
               {
                   ...
                   out.println("<p align=\"center\">Item edited successfully. <br /> you may want to <a href=\"EditItemDetails.jsp?ItemID=" + mrequest.getParameter("ItemID") + "\">edit details</a> about the item you just edited<br /> Go back to <a href=\"Item.jsp?ItemID=" + mrequest.getParameter("ItemID") + "\">Item Page</a>.</p></p>");
                   db.disconnect();
               }
